...
export default function ScrollVideoComponent() {
  ...
  return (
    ...
    <section ref={containerRef} className="relative h-[200vh] w-full">
      ...
      <div className="sticky top-0 left-0 w-screen h-screen overflow-hidden z-0 pointer-events-none">
      ...
      <div className="sticky top-0 left-0 w-full h-screen overflow-hidden flex items-center justify-center pointer-events-none z-10">
        ...
        <div ref={text1Ref} className="absolute text-center opacity-0 text-white drop-shadow-lg">
        ...
        <div ref={text2Ref} className="absolute text-center opacity-0 text-white drop-shadow-2xl">
          ...
          <div className="flex justify-center gap-6 pointer-events-auto">
            <a href="https://github.com/sush8471" target="_blank" rel="noreferrer" className="hover:text-gray-400 transition-colors duration-300">
            ...
            <a href="https://www.linkedin.com/in/sushant-chaudhary-aa062a231/" target="_blank" rel="noreferrer" className="hover:text-gray-400 transition-colors duration-300">
